...
public class topIntegers {
    public static void main(String[] args) {
        ...
        // 1. трябва да обходим всички числа от първото до последното
        // 2. трябва да проверим дали всички числа от дясно на всяко число
        // са по-малки или по-големи
        // 3. след това ако числата са по-малки,значи числото е Top Int. и го принтираме
